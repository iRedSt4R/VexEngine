...
public:
	...
	void CreateFromFile(ID3D12GraphicsCommandList* cmdList, std::wstring pathToTexture) 
	{ 
		m_textureResource = DX12ResoruceAllocator::Get()->AllocateTexture2DFromFilepath(cmdList, pathToTexture); 
	};
